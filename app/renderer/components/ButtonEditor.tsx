        ...
        <div className="button-editor">
            ...
            <label className="button-editor-field">
                ...
                <input
                    ...
                    placeholder="e.g. obs.startStreaming"
                />
            </label>
            ...
            <label className="button-editor-field">
                ...
                <textarea
                    ...
                    onBlur={e => handlePayloadChange(e.target.value)}
                    placeholder={'e.g. { "scene": "Camera 1", "url": "https://..." }'}
                    rows={3}
                    spellCheck={false}
                />
